...
flowchart TD
    ...
    L3 --> M{"นักเรียนใช้แต้มทำอะไรต่อ (FE-24/FE-25/FE-26)"}
...
flowchart TD
    ...
    D --> H["ระบบตัดสินผลแข่งขันด้วยค่าสเตตัสจากขั้นการเติบโต (FE-27)"]
    E --> H
    F --> H
    G --> H
...
| A, B, H | ระบบเข้าหน้าจัดการ / คำนวณและตัดสินผลด้วยค่าสเตตัสจากขั้นการเติบโต | FE-27 |
