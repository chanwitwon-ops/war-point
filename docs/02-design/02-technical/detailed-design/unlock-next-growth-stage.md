...
| ERR-04 | `available_points` ไม่ถึงเกณฑ์ของขั้นถัดไป | ไม่หักแต้ม ไม่เปลี่ยนสถานะ | 422 INSUFFICIENT_POINTS |
...
```mermaid
stateDiagram-v2
    "egg" --> "stage1" : "จ่าย 5 แต้ม (DD-02)"
    "stage1" --> "stage2" : "จ่าย 10 แต้ม (DD-02)"
    "stage2" --> "stage3" : "จ่าย 15 แต้ม (DD-02)"
    "stage3" --> "stage4" : "จ่าย 20 แต้ม (DD-02)"
    "stage4" --> "stage4" : "ปลดล็อกอีกไม่ได้ (ERR-06)"
```
